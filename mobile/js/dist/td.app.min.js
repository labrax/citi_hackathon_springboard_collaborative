...
hideTabBar.directive('hideTabBar', function ($timeout) {
  ...
  angular
    ...
    .factory('Cases', function ($http, $localStorage) {
      return {
        all: function (page) {
          void 0 === page && (page = 0)
                ...
                switch (index) {
                  case 0:
                    ...
                    return (
                      Tickets.update(reqTicket).then(
                        function (response) {
                          ;($scope.ticket.status = 1), $scope.showSnackbar('Case status set to Open')
                        },
                        function (response) {
                          console.log(response)
                        }
                  ...
                  case 1:
                    ...
                    return (
                      Tickets.update(reqTicket).then(
                        function (response) {
                          ;($scope.ticket.status = 2), $scope.showSnackbar('Case status set to Pending')
                        },
                        function (response) {
                          console.log(response)
                        }
              ...
              switch (index) {
                ...
                case 1:
                  ...
                  return (
                    Tickets.update(reqTicket).then(
                      function (response) {
                        ;(t.status = 1), $scope.showSnackbar('Case status set to Open')
                      },
                      function (response) {
                        console.log(response)
                      }
                ...
                case 2:
                  ...
                  return (
                    Tickets.update(reqTicket).then(
                      function (response) {
                        ;(t.status = 2), $scope.showSnackbar('Case status set to Pending')
                      },
                      function (response) {
                        console.log(response)
                      }
